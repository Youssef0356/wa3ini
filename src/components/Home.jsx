...
//           <h1 className="text-8xl p-5">وعيني</h1>
...
//         <Link to={to}>
//           <img className="h-56 lg:h-60 w-full object-cover" src={imageLink} />
//           <div className="p-3">
...
//             <h1 className=" text-2xl font-bold  sm:text-2xl sm:p-2 ">👋"وعيني"</h1>
//             <h1 className=" text-2xl font-bold  sm:text-2xl sm:p-2 ">مرحبا بيك في</h1>
//           </div>
//           <hr />
//           <Introduction />
//         </div>
...
//             to="/autism"
//             imageLink={autism}
//             description="التوحد يُعتبر حالة عصبية تنموية معقدة، تتسم بتحديات في التفاعل الاجتماعي، والتواصل، ونمط السلوك"
//           />
//           <GridCard
//             title="المشاكل السمعية"
//             to="/"
//             imageLink={deaf}
//             description="الصمم فقدان القدرة على السمع، مما يجعل من الصعب سماع الأصوات والتواصل بشكل طبيعي"
//           />
//           <GridCard
//             title="المشاكل البصرية"
//             to="/"
//             imageLink={blind}
//             description="العمى هو حالة طبية تتميز بفقدان كبير للرؤية، مما يؤدي إلى عدم القدرة على رؤية أو إدراك المعلومات البصرية "
//           />
//           <GridCard
//             title="المشاكل النفسية"
//             to="/"
//             imageLink={mind}
//             description="الاعاقه  الذهنية هي الاعاقة العقلية الناتجة عن خلل في الوظائف العليا للدماغ كالتركيز والعد والذاكرة والاتصال مع الآخرين وغيرها"
//           />
//           <GridCard
//             title="الامراض المزمنة"
//             to="/"
//             imageLink={chronic}
//             description="المرض المزمن هو حالة صحية تتسم بطول مدتها واستمرارها لفترة طويلة، وقد تستمر لعدة سنوات أو حتى مدى الحياة"
//           />
//           <GridCard
//             title="المشاكل الحركية والشلل"
//             to="/"
//             imageLink={Paralysis}
//             description="الشلل هو فقدان القدرة على الحركة (وأحياناً الإحساس) في جزء أو معظم الجسم، وعادةً ما يكون نتيجة لتلف في الجهاز العصبي "
//           />
//         </div>
//       </section>
//       <section className="flex w-full bg-gradient-to-bl from-indigo-100 to-pink-50 p-8">
