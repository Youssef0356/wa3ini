    ...
    <div className="sm:ml-64">
      ...
      <section className="min-h-screen w-full bg-gradient-to-br from-pink-50 to-indigo-100 p-8">
        ...
        <div className="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10">
          ...
          <GridCard title="المشاكل النفسية" to="/" imageLink={mind} description="الاعاقه  الذهنية هي الاعاقة العقلية الناتجة عن خلل في الوظائف العليا للدماغ كالتركيز والعد والذاكرة والاتصال مع الآخرين وغيرها" />
